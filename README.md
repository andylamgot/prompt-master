...
**Works with:** Z.ai GLM, SEEDANCE, Claude, ChatGPT, Gemini, o1/o3, MiniMax, Cursor, Claude Code, GitHub Copilot, Windsurf, Bolt, v0, Lovable, Devin, Perplexity, Midjourney, DALL-E, Stable Diffusion, ComfyUI, Sora, Runway, ElevenLabs, Zapier, Make, and any AI tool you throw at it.
...
- **1.5.1** - Version Update: Change version: 1.6.0 to version: 1.6.1 at the top of the file. Tool Routing: Added z.ai GLM to the LLM list. Image Generation: Added SEEDANCE2.0 to the Image AI list.
